...
Author: Tech Nomad
License: MIT (Copyright (c) 2025 Tech Nomad)
This file is copied verbatim from upstream. See NOTICE.md at repo root.

TIER 2 (INTERACTIVE): This is a role-based, multi-turn dialogue prompt.
Paste it into your model of choice, then respond to its questions iteratively
until it produces the final artifact.
-->
